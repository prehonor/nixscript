...
[
   ...
   gtksourceview       # Source code editing widget for GTK
   ...
   # glibc			   # The GNU C Library 导致问题编译cpp出现 <stdlib.h> not found https://discourse.nixos.org/t/trouble-in-building-c-environment/1413
