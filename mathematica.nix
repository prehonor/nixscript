...
let fhs = pkgs.buildFHSUserEnv {
  name = "mathematica_install_start";
...
in pkgs.stdenv.mkDerivation {
  ...
  python = python3.withPackages(ps: with ps; [ pip urllib3 pytorch-bin torchvision-bin pyside2 ]); # pytorchWithoutCuda
  public_libs = [
    libGL gnome2.GConf
  ...
  shellHook = ''
    ...
    exec mathematica_install_start
  '';
